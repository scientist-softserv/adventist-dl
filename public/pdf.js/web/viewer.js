...
class ConstL10n extends _l10n_js__WEBPACK_IMPORTED_MODULE_3__.L10n {
  constructor(lang) {
    ...
    this._setL10n(new fluent_dom__WEBPACK_IMPORTED_MODULE_1__.DOMLocalization([], ConstL10n.#generateBundles.bind(ConstL10n, lang)));
  }
  ...
  static get instance() {
    return (0,pdfjs_lib__WEBPACK_IMPORTED_MODULE_2__.shadow)(this, "instance", new ConstL10n("en-us"));
  }
}
const NullL10n = {
  getLanguage() {
...
const pdfjsVersion = '4.0.250';
const pdfjsBuild = '83f002921';
const AppConstants = {
