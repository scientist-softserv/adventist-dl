      ...
      private
        ...
        def attach_files(env, remote_files)
          ...
          remote_files.each do |file_info|
            ...
            # OVERRIDE Hyrax 2.9.5 to override default_thumbnail
            create_file_from_url(env, uri, file_info[:file_name], auth_header, file_info[:default_thumbnail])
          end
          true
        end
        ...
        def create_file_from_url(env, uri, file_name, auth_header = {}, override_default_thumbnail = nil)
          import_url = URI.decode_www_form_component(uri.to_s)
          # OVERRIDE Hyrax 2.9.5 to override default_thumbnail
          ::FileSet.new(import_url: import_url, label: file_name, override_default_thumbnail: override_default_thumbnail) do |fs|
