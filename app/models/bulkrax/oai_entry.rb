# from bulkrax version 4.3 to fix where vs find_by issue
...
module Bulkrax
  class OaiEntry < Entry
    ...
    def find_collection_ids
      ...
      sets.each do |set|
        c = Collection.where(work_identifier => importerexporter.unique_collection_identifier(set.content)).first
