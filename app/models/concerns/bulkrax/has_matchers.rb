...
module Bulkrax
  module HasMatchers
    ...
    class_methods do
      ...
      def matcher(name, args = {})
        matcher = matcher_class.new(
          ...
          default_thumbnail: args[:default_thumbnail]
        )
    ...
    def matched_metadata(multiple, name, result, object_multiple)
      return result if name == 'thumbnail_url'
    ...
    def field_supported?(field)
      ...
      return true if %W[id file remote_files model delete thumbnail_url #{parser.collection_field_mapping}].include?(field)
